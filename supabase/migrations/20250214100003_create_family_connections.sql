...
create index idx_family_connections_crew on public.family_connections(crew_id);
create index idx_family_connections_family on public.family_connections(family_id);
create index idx_family_connections_approved on public.family_connections(status) where status = 'approved';
