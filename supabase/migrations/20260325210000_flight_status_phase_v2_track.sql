-- Önceki 20260325200000 sürümü (pasif geçmiş→landed) uygulanmış projeler için:
-- pasif geçmiş→scheduled, pasif gelecek + track/indi zamanı→landed, last_seen_utc sütunu.
