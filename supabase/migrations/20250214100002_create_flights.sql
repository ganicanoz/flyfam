...
create index idx_flights_crew_date on public.flights(crew_id, flight_date);
create index idx_flights_date_number on public.flights(flight_date, flight_number);
